  ...
  return (
    <Card className="w-full max-w-md">
      <CardHeader>
        ...
        <p className="text-sm text-slate-500 dark:text-zinc-500">Set up your workspace and start sending contracts today.</p>
      </CardHeader>
      ...
      <CardFooter className="text-sm text-slate-500 dark:text-zinc-500">
        Already have an account? <Link href="/login" className="ml-1 text-blue-600 dark:text-blue-400">Sign in</Link>
      </CardFooter>
    </Card>
  );
}
