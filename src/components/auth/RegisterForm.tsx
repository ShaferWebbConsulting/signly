  ...
  return (
    <Card className="w-full max-w-md">
      <CardHeader>
        ...
        <p className="text-sm text-slate-500 dark:text-zinc-400">Set up your workspace and start sending contracts today.</p>
      </CardHeader>
      ...
      <CardFooter className="text-sm text-slate-500 dark:text-zinc-400">
        Already have an account? <Link href="/login" className="ml-1 text-blue-600 hover:text-blue-700 dark:text-violet-400 dark:hover:text-violet-300">Sign in</Link>
      </CardFooter>
    </Card>
  );
}
