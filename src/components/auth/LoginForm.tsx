  ...
  return (
    <Card className="w-full max-w-md">
      <CardHeader>
        ...
        <p className="text-sm text-slate-500 dark:text-zinc-500">Continue managing contracts, approvals, and audit-ready signatures.</p>
      </CardHeader>
      ...
      <CardFooter className="flex flex-col items-start gap-2 text-sm text-slate-500 dark:text-zinc-500">
        <Link href="/forgot-password" className="text-blue-600 dark:text-blue-400">Forgot your password?</Link>
        <p>
          Need an account? <Link href="/register" className="text-blue-600 dark:text-blue-400">Create one</Link>
        </p>
      </CardFooter>
    </Card>
  );
